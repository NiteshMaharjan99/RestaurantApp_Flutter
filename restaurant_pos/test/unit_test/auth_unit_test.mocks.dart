...
// in restaurant_pos/test/unit_test/auth_unit_test.dart.
...
import 'package:restaurant_pos/core/failure/failure.dart' as _i7;
...
class MockUserUseCase extends _i1.Mock implements _i5.UserUseCase {
  @override
  _i6.Future<_i2.Either<_i7.Failure, bool>> registerUser(
          _i8.StudentEntity? user) =>
      (super.noSuchMethod(
        Invocation.method(
          #registerUser,
          [user],
